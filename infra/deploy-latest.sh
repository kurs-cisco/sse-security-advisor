...
RELEASE_PREFIX="transfer/releases/2026-09-22"
...
python -c 'import boto3,os; client=boto3.client("s3"); bucket=os.environ["CBOM_SNAPSHOT_BUCKET"]; files=[("transfer/releases/2026-09-22/FIPS-140-3-21-sept.json","/tmp/target-modules.json"),("transfer/releases/2026-09-22/fips-module-public-evidence-2026-09-21.json","/tmp/public-evidence.json"),("transfer/releases/2026-09-22/current-version-correlation-2026-09-21.json","/tmp/catalog-evidence.json"),("transfer/releases/2026-09-22/service_impact.csv","/tmp/service_impact.csv")]; [client.download_file(bucket,key,path) for key,path in files]'
